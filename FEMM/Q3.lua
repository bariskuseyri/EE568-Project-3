...
stator_radius_outer = 0.080
rotor_radius_outer = 0.025
airgap = 0.001



slot_radius_inner = rotor_radius_outer + airgap
stator_radius_inner = rotor_radius_outer + airgap
backiron = 2 * 1.5 * pi * slot_radius_inner / (2*Ns)
slot_radius_outer = stator_radius_outer - backiron
